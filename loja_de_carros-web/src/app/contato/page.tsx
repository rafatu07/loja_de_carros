      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <h2 className="text-2xl font-bold text-zinc-900 mb-6">Envie sua Mensagem</h2>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label htmlFor="assunto" className="block text-sm font-medium text-zinc-700 mb-2">
                    Assunto
                  </label>
                  <select
                    id="assunto"
                ...
                <div>
                  <label htmlFor="mensagem" className="block text-sm font-medium text-zinc-700 mb-2">
                    Mensagem
                  </label>
                  <textarea
                    id="mensagem"
            ...
            >
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                <h2 className="text-2xl font-bold text-zinc-900 mb-6">Localização</h2>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-medium text-zinc-900">(99) 99999-9999</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-medium text-zinc-900">contato@lojadecarros.com.br</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
              ...
              {/* Redes Sociais */}
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                <h2 className="text-2xl font-bold text-zinc-900 mb-6">Redes Sociais</h2>
