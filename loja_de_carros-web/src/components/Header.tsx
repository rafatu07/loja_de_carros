        ...
        <nav className="py-4">
          <div className="flex justify-between items-center">
            <Link href="/" className="text-2xl font-bold text-blue-600 flex items-center">
              <FaCar className="mr-2" /> Loja de Carros
            </Link>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/estoque" className="text-gray-700 hover:text-blue-600 transition-colors">
                Estoque
              </Link>
              ...
              <Link href="/" className="text-gray-700 hover:text-blue-600 transition-colors relative">
          ...
          {isMenuOpen && (
            <div className="md:hidden mt-4 space-y-4">
              ...
              <Link href="/estoque" className="block text-gray-700 hover:text-blue-600">
                Estoque
              </Link>
              <Link href="/sobre" className="block text-gray-700 hover:text-blue-600">
                Sobre
              </Link>
              <Link href="/contato" className="block text-gray-700 hover:text-blue-600">
                Contato
              </Link>
              <div className="flex items-center space-x-4">
                ...
                <Link href="/carrinho" className="text-gray-700 hover:text-blue-600 relative">
                  <FaShoppingCart className="text-xl" />
                  <span className="absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">
                    0
                  </span>
